 ...
 * mer 13 mar 2013, 18.15.10, CET 
 * compat-wireless-2.6: compat-wireless-v3.5.4-1-s
 * linux-2.6: v3.5.4
 */
#define COMPAT_RELEASE "compat-wireless-v3.5.4-1-s"
#define COMPAT_KERNEL_RELEASE "v3.5.4"
